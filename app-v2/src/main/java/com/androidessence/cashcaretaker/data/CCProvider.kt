...
/**
 * ContentProvider for accessing the CC database.
 *
...
class CCProvider : ContentProvider() {
    ...
    companion object {
        ...
        private val transactionWithCategoryBuilder: SQLiteQueryBuilder = SQLiteQueryBuilder()
        ...
        private val repeatingTransactionDetailsBuilder: SQLiteQueryBuilder = SQLiteQueryBuilder()
