...
/**
 * Contract class that defines the database layout for Cash Caretaker.
 *
...
object CCContract {
    ...
    class AccountEntry : BaseColumns {
        companion object {
            ...
            val CONTENT_TYPE = "vnd.android.cursor.dir/$CONTENT_URI/$PATH_ACCOUNT"
            val CONTENT_ITEM_TYPE = "vnd.android.cursor.item/$CONTENT_URI/$PATH_ACCOUNT"
    ...
    class CategoryEntry : BaseColumns {
        companion object {
            ...
            val CONTENT_TYPE = "vnd.android.cursor.dir/$CONTENT_URI/$PATH_CATEGORY"
            val CONTENT_ITEM_TYPE = "vnd.android.cursor.item/$CONTENT_URI/$PATH_CATEGORY"
    ...
    class TransactionEntry : BaseColumns {
        companion object {
            ...
            val CONTENT_TYPE = "vnd.android.cursor.dir/$CONTENT_URI/$PATH_TRANSACTION"
            val CONTENT_ITEM_TYPE = "vnd.android.cursor.item/$CONTENT_URI/$PATH_TRANSACTION"
    ...
    class RepeatingPeriodEntry : BaseColumns {
        companion object {
            ...
            val CONTENT_TYPE = "vnd.android.cursor.dir/$CONTENT_URI/$PATH_REPEATING_PERIOD"
            val CONTENT_ITEM_TYPE = "vnd.android.cursor.item/$CONTENT_URI/$PATH_REPEATING_PERIOD"
    ...
    class RepeatingTransactionEntry : BaseColumns {
        companion object {
            ...
            val CONTENT_DETAILS_URI = CONTENT_URI.buildUpon().appendPath(PATH_DETAILS).build()

            val CONTENT_TYPE = "vnd.android.cursor.dir/$CONTENT_URI/$PATH_REPEATING_TRANSACTION"
            val CONTENT_ITEM_TYPE = "vnd.android.cursor.item/$CONTENT_URI/$PATH_REPEATING_TRANSACTION"
